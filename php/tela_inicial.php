<?php
	if (isset($_SESSION["usuario_id"])) {
		...
		// O ID do usuário está disponível na variável $usuarioId
		// Você pode prosseguir com a inserção na tabela exercicios_usuarios
        echo $usuarioId;
	} else {
		echo "nao foi atribuido o usuario_id";
	}	
?>
